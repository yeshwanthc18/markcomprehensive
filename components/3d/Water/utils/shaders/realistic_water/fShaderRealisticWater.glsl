...
uniform float iTime;       // Time passed since the start
uniform vec2 iMouse;       // Mouse position

#define DRAG_MULT 0.38 // changes how much waves pull on the water
#define WATER_DEPTH 0.8 // how deep is the water - default 1.0
#define CAMERA_HEIGHT 3.5 // how high the camera should be
