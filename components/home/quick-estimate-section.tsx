    ...
    <section className="py-24 relative overflow-hidden">
      <div className="container mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
        <div className="text-center mb-16">
          <Badge className="mb-6 bg-[#01adff]/10 text-[#01adff] hover:bg-[#01adff]/20 px-6 py-2 font-semibold">
            <Calculator className="w-4 h-4 mr-2" />
            Quick Estimate
          </Badge>

          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-[#1c345c] mb-6 leading-tight">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <button
              onClick={openPopup}
              className="inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-[#01adff] to-[#0096d6] text-white font-semibold  shadow-lg hover:shadow-xl transition-all duration-300"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
          <div className="text-center p-8 bg-white shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
            <div className="w-16 h-16 bg-[#01adff]/10 flex items-center justify-center mx-auto mb-6">
