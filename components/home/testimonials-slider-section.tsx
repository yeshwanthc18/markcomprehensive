  ...
  return (
      ...
      style={
        {
          ...
          ["--brand-deep" as any]: BRAND.deep,
          ["--brand-black" as any]: BRAND.black,
          ["--brand-white" as any]: BRAND.white,
    ...
    >
      <div className="container mx-auto px-6 md:px-8">
        ...
        >
          <div ref={trackRef} className="flex gap-6 md:gap-8 will-change-transform select-none">
            {loopItems.map((t, idx) => (
              <Card
                key={`${t.id}-${idx}`}
                data-card
                className="min-w-[85%] sm:min-w-[420px] lg:min-w-[520px] border backdrop-blur-2xl"
              >
                <CardContent className="p-6 md:p-8">
                  <div className="flex items-center justify-between pb-4">
                    <div className="flex items-center gap-3">
                      <img
                        src={t.image || "/placeholder.svg?height=48&width=48&query=client%20avatar"}
                        alt={t.name}
                    ...
                    <Badge
                      variant="outline"
                      className="px-4 py-2"
                      style={{ borderColor: BRAND.deep, color: BRAND.navy, background: BRAND.white }}
