              ...
              <div className="space-y-6 mb-8">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <div className="text-blue-100">Halban Industrial Area, Sultanate of Oman</div>
                  </div>
                </div>
                <div className="flex items-center space-x-4">
                  <div className="p-3 bg-white/10 ">
                  ...
                  <div>
                    <div className="font-semibold text-white">Facility</div>
                    <div className="text-blue-100">Modern Aluminum Fabrication & Assembly Lines</div>
                  </div>
                </div>
              </div>
            </div>
