...
export default function AboutPartnershipsSection() {
  return (
      ...
      <div className="relative container mx-auto px-6 sm:px-8 lg:px-12 text-center">
        <ScrollTriggerComponent animation="fadeInUp">
          ...
          <p className="text-xl text-blue-100 max-w-4xl mx-auto leading-relaxed">
            Mark Comprehensive LLC is one of the leading façade specialist engaged in the design, fabrication and
            installation of architectural aluminum systems. Through strategic alliances with global industry leaders and
            a commitment to excellence, we deliver architectural solutions that define skylines and inspire communities
