...
const services = [
  {
    ...
    description:
      "Advanced curtain wall systems and structural glazing solutions that combine architectural beauty with engineering excellence for modern buildings.",
  ...
  },
  {
    ...
    description:
      "Complete interior architectural solutions including partitions, decorative elements, and custom metalwork for modern spaces.",
...
export default function AboutServicesSliderSection() {
